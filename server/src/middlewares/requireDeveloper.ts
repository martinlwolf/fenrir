...
import { ForbiddenException, UnauthorizedException } from "../exceptions/common";
import { developerExists } from "../daos/project.dao";
...
export async function requireDeveloper(
  ...
  try {
    ...
    const exists = await developerExists(req.wallet);
