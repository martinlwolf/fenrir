...
contract FenrirProject is ReentrancyGuard {
    ...
    uint256 public totalReleasedToDeveloper;
    uint256 public penaltyAccumulatedBps;

    uint256 public commissionBasis;
    uint256 public reservedCommission;
    bool public commissionClaimed;
    ...
    constructor(
        ...
        require(milestoneBudgets_.length == milestoneDurations_.length && milestoneBudgets_.length > 0, "FenrirProject: milestones mismatch");
    ...
    function onArbiterElected(address newArbiter) external onlyGovernor {
    ...
    function onMilestoneResolved(uint256 milestoneId, bool approved) external onlyGovernor {
    ...
    function onSaleOfferResolved(uint256 offerId, bool approved) external onlyGovernor {
