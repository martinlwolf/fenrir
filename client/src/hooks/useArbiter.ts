...
// "soy el arbitro" y el panel de desempate (arbiterDecide). El polling cada 4s mantiene
// needsOpening sincronizado sin recargar la pagina (OpenArbiterElectionPanel lo consume).
