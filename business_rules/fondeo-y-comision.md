...
La ronda de inversión se cierra recién al alcanzar el **FF**; entre el FMPA y el FF la obra ya está en marcha pero todavía pueden sumarse inversores nuevos y emitirse FDT. Una inversión no puede superar lo que todavía falta para el FF: el contrato la rechaza entera y quien invierte debe reintentar con el monto exacto que resta (o menos). Esto evita que quede plata de más sin asignar a ningún hito, que se trabaría en el contrato sin ningún mecanismo para recuperarla una vez completado el proyecto.
